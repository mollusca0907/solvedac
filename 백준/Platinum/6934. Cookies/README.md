...
### 입력 
 ...
 <p>Input consists of a positive integer $n$ not greater than $10$, followed by $n$ lines of input. Each line gives the coordinates of one chocolate chip on the plane. Each coordinate is an integer in the range $[0, 1000]$.</p>
